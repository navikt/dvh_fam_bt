...
with barn as (
    select *
    from {{ ref('fak_bt_px_barn') }}
    where belop > 0 -- Etterbetalinger til mottaker telles ikke
    --and barn_selv_mottaker_flagg = 0 --Barn selv mottar barnetrygd telles ikke
)
,
...
full_liste as (
    ...
    from {{ ref('dim_bt_px_navarende_fylke') }} fylke
...
agg as (
    ...
    and full_liste.nåværende_fylke_nr = barn.navarende_fylke_nr
